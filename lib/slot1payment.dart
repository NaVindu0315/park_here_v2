...
class slot1pay extends StatefulWidget {
  const slot1pay({Key? key}) : super(key: key);

  @override
  _slot1payState createState() => _slot1payState();
}

class _slot1payState extends State<slot1pay> {
  ...
  void initState() {
    super.initState();
    _databaseReference =
        FirebaseDatabase.instance.reference().child('Vehicle4/ParkingDuration');
    ...
    _databaseReference =
        FirebaseDatabase.instance.reference().child('Vehicle4/ParkingCost');
    _databaseReference.onValue.listen((event) {
      setState(() {
  ...
  void update(double value) {
    _database.child('Vehicle4/ParkingCost').set(value);
  }

  ///cost end
  ///time
  void uptime(String value) {
    _database.child('Vehicle4/ParkingDuration').set(value);
  }
